...
class TestRegistration():
    ...
    def test_registration_1_happy_path(self):
        ...
        assert welcome_text_elt.text == self.welcome_text, \
    ...
    def test_registration_2_negative_flow(self):
        ...
        try:
            with pytest.raises(NoSuchElementException):
                self.browser.find_element(By.CSS_SELECTOR, ".first_block .second_class input")
                pytest.fail("Не должно быть второго поля вводу")
        finally:
            self.browser.quit()
